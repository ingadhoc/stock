...
class StockValuationLayer(models.Model):
    ...
    def move_is_return(self):
        return bool(self.stock_move_id.origin_returned_move_id and self.stock_move_id.origin_returned_move_id.sudo().stock_valuation_layer_ids)
            ...
            if not rec.bypass_currency_valuation and rec.valuation_currency_id:
                ...
                if rec.stock_move_id and (rec.stock_move_id._is_out() or rec.stock_move_id.is_inventory):
                    ...
                    if rec.stock_move_id.origin_returned_move_id:
                        unit_cost_in_currency = rec.stock_move_id.origin_returned_move_id.stock_valuation_layer_ids.unit_cost_in_currency

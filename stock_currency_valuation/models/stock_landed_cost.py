...
class AdjustmentLines(models.Model):
    ...
    def _create_accounting_entries(self, move, qty_out):
        ...
        valuation_currency_id = self.product_id.with_company(self.cost_id.company_id.id).categ_id.valuation_currency_id
        if valuation_currency_id and amount:
            if self.cost_id.currency_rate:
                ...
                value_in_currency = self.cost_id.currency_id._convert(
                    from_amount=amount,
                    to_currency=valuation_currency_id,
            ...
            AccountMoveLine[1][2].update(
                {
                    "currency_id": valuation_currency_id.id,

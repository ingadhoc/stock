...
#. Log routes configuration changes: routes and warehouses get a chatter, changes on their rules are logged on the route chatter, and changing the warehouse reception or delivery steps logs which rules were activated, archived or created. Everything can be turned off with "Track Routes Configuration Changes" in the Inventory settings.

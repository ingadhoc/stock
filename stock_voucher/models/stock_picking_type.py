...
class StockPickingType(models.Model):
    ...
    voucher_number_unique = fields.Boolean(
        string="Book Unique?",
        help="If true, voucher numbers will be required to be unique for same" " partner",
    )
    book_id = fields.Many2one("stock.book", "Book", help="Book suggested for pickings of this type", check_company=True)
